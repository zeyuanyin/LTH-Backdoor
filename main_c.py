...
parser.add_argument('--save', default='./O_poisonresult_white/1/pruned_3029_0.3', type=str, metavar='PATH',
                    help='path to save prune model (default: current directory)')
parser.add_argument('--arch', default='vgg', type=str,
                    help='architecture to use')
parser.add_argument('--scratch', default='./O_poisonresult_white/1/pruned_3029_0.3/pruned.pth.tar', type=str,
...
for epoch in range(args.start_epoch, args.epochs):
    ...
    # }, is_best=False, epoch=epoch, filepath=args.save)
