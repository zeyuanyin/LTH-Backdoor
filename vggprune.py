...
parser.add_argument('--model', default='./baseline/vgg16-cifar10/EB-30-17.pth.tar', type=str, metavar='PATH',
                    help='path to the model (default: none)')
parser.add_argument('--save', default='./baseline/vgg16-cifar10/pruned_3017_0.3', type=str, metavar='PATH',
